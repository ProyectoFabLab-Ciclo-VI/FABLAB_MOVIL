import 'package:fab_lab_upeu/features_venta/fablab/presentation/pages/Login_Reset_Register/Register/creacion_exitoso.dart';
...
class VerificarRegister extends StatelessWidget {
  const VerificarRegister({super.key});
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 20),
                  Text(
                    "Enviamos enlace de verificación a tu correo electrónico.",
                    style: TextStyle(
                      fontSize: 14,
                      color: coloresPersonalizados[5],
                    ),
