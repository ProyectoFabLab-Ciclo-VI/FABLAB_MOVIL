          ...
          children: [
            ...
            Expanded(
              child: GestureDetector(
                onTap: () => controller.onItemTapped(0), // Cambia el estado a "Log in"
                child: Container(
                  padding: const EdgeInsets.symmetric(vertical: 15),
                  decoration: loginDecoration(controller.selectedIndex == 0), // Estilo del botón
                  child: Center(
                    child: Text(
                      'Log in',
                      style: textStyle(controller.selectedIndex == 0), // Estilo del texto
                    ),
                  ),
                ),
              ),
            ...
            Expanded(
              child: GestureDetector(
                onTap: () => controller.onItemTapped(1), // Cambia el estado a "Register"
                child: Container(
                  padding: const EdgeInsets.symmetric(vertical: 15),
                  decoration: registerDecoration(controller.selectedIndex == 1), // Estilo del botón
                  child: Center(
                    child: Text(
                      'Register',
                      style: textStyle(controller.selectedIndex == 1), // Estilo del texto
                    ),
                  ),
                ),
              ),
